...
public class RepackingScanCode extends AppCompatActivity {
    ...
    String stockinDate = "";
    String fromCd = "" , Warehouse_Position_CD ="";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Warehouse_Position_CD = sharedPreferencess.getString("Warehouse_Position_CD", "");
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting.equals("HoneyWell")) {
                    ...
                    if (ContextCompat.checkSelfPermission(RepackingScanCode.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(RepackingScanCode.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position != null || checkToFinish != null) {
                    Intent intent = new Intent(RepackingScanCode.this, RepackingListProduct.class);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(RepackingScanCode.this);
                } catch (Exception e) {
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(RepackingScanCode.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void init() {
        ...
        textViewTitle.setText("QUÉT MÃ - REPACKING");
...
//        vitritu = intent.getStringExtra("vitritu");
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(RepackingScanCode.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(RepackingScanCode.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(RepackingScanCode.this, barcodeData + "", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(RepackingScanCode.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
                                    Log.d("#777", e.getMessage());
                                    Intent intent = new Intent(RepackingScanCode.this, RepackingListProduct.class);
                                    intent.putExtra("repacking", "333");
    ...
    private void GetData(final String barcodeData) {
        ...
        if (checkBoxGetLPN.isChecked()) {
            if (expiredDate != null) {
                Intent intentt = new Intent(getApplication(), RepackingListProduct.class);
                ...
                intentt.putExtra("repacking", "333");
            ...
            if(!(position == null)){
                ...
                if (statusGetcode != 1) {
                    ...
                    if (product_s_ps.size() > 1) {
                        final AlertDialog.Builder builder = new AlertDialog.Builder(RepackingScanCode.this);
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
                        ...
                        Toast.makeText(RepackingScanCode.this, "Mã Barcode Không Có Trong Hệ Thống", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(RepackingScanCode.this, RepackingListProduct.class);
                        startActivity(intent);
                        finish();
                    }
                    ...
                    if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                        if (expDate != "") {
                            ...
                            if (chuoi[0].equals("Khác")){
                                Intent intent = new Intent(RepackingScanCode.this, SelectPropertiesProductActivity.class);
                        ...
                        Toast.makeText(RepackingScanCode.this, "You select: " + expDate,
...
//                }
            ...
            Toast.makeText(RepackingScanCode.this, "Không Tìm Thấy Sản Phẩm ", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(RepackingScanCode.this, RepackingListProduct.class);
            startActivity(intent);
            finish();
        }
...
//        }
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow,final String batch_number) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(RepackingScanCode.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(RepackingScanCode.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), RepackingListProduct.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("pro_code", pro_code);
                intentt.putExtra("pro_name", pro_name);
