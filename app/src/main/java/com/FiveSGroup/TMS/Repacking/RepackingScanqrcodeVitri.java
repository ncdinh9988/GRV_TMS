...
public class RepackingScanqrcodeVitri extends AppCompatActivity {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(!statusGetcode.equals("error")){
                            ...
                            Toast.makeText(RepackingScanqrcodeVitri.this, "Không tìm thấy vị trí trong kho" , Toast.LENGTH_LONG).show();
                        }
    ...
    private void init() {
        ...
        textViewTitle.setText("QUÉT MÃ - VỊ TRÍ REPACKING");
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(RepackingScanqrcodeVitri.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
