...
public class Product_Master_Pick {
    ...
    public String getMASTER_PICK_CD() {
        return PICKLIST_CD;
    }

    public void setMASTER_PICK_CD(String MASTER_PICK_CD) {
        this.PICKLIST_CD = MASTER_PICK_CD;
    }
