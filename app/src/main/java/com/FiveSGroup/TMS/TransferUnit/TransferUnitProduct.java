...
public class TransferUnitProduct {
    ...
    public String getUNIT_CHANGE_TO() {
        return UNIT_CHANGE_TO;
    }

    public void setUNIT_CHANGE_TO(String UNIT_CHANGE_TO) {
        this.UNIT_CHANGE_TO = UNIT_CHANGE_TO;
    }
