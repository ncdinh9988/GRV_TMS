...
public class HomeQRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_q_r);
...
//        Log.e("new4","là : " + value4);
        ...
        urlStockReceipt = DatabaseHelper.getInstance().getParamByKey("URL_Stockin").getValue();


        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeQRActivity.this, Qrcode.class);
        ...
        btnShow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeQRActivity.this, ListQrcode.class);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HomeQRActivity.this, MainWareHouseActivity.class));
                finish();
            }
        });
    ...
    private void addEvents(String url) {
        if (CmnFns.isNetworkAvailable()) {
            mWebview.addJavascriptInterface(new JavaScriptInterface(HomeQRActivity.this), "Android");
            ...
            mWebview.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.contains("StockReceiptListItemForApp.aspx?STOCK_RECEIPT_CD")) {

                        String chuoi[] = url.split("=");
                        String code = chuoi[1];
                        global.setStockReceiptCd(code);
    ...
    public void onDestroy() {
        super.onDestroy();
        SharedPreferences settings = this.getSharedPreferences("name_stockin", Context.MODE_PRIVATE);
        settings.edit().clear().apply();
    }
    ...
    public void onResume() {
        ...
        SharedPreferences prefs = this.
                getSharedPreferences("name_stockin", Activity.MODE_PRIVATE);
