...
public class PickList {
    ...
    private String PICKLIST_ORDER_CD;
    ...
    public String getPickListCD() {
        return PICKLIST_ORDER_CD;
    }

    public void setPickListCD(String pickListCD) {
        PICKLIST_ORDER_CD = pickListCD;
    }
