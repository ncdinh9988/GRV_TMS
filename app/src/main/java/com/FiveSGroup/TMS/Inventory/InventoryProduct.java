...
public class InventoryProduct {
    ...
    public String getSTOCK_TAKE_CD() {
        return STOCK_TAKE_CD;
    }

    public void setSTOCK_TAKE_CD(String STOCK_TAKE_CD) {
        this.STOCK_TAKE_CD = STOCK_TAKE_CD;
    }
