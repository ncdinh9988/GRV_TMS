...
import com.FiveSGroup.TMS.QA.Return_QA.Qrcode_Return_QA;
...
private CodeScanner mCodeScanner;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    CmnFns.hideSoftKeyboard(Qrcode_Remove_LPN.this);
                }catch (Exception e){
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_Remove_LPN.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void GetData(final String barcodeData){
        ...
        if (checkBoxGetLPN.isChecked()) {
            if (expiredDate != null) {
                ...
                Intent intentt = new Intent(Qrcode_Remove_LPN.this, List_Remove_LPN.class);
                intentt.putExtra("lpn", "444");
                intentt.putExtra("btn1", barcodeData);
                intentt.putExtra("remove_lpn", "333");
                intentt.putExtra("id_unique_RML", id_unique_RML);
            ...
            if (statusGetcode != 1) {
                ...
                if (product_s_ps.size() > 1) {
                    final AlertDialog.Builder builder = new AlertDialog.Builder(Qrcode_Remove_LPN.this);
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
    ...
    private void getinformation(final String barcodeData) {
        int statusGetCustt = new CmnFns().getDataFromSeverWithBatch2(barcodeData, CmnFns.readDataAdmin(), "WLP", 0, "");
...
//        }
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow,final String batch_number ) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_Remove_LPN.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_Remove_LPN.this, mString[which], Toast.LENGTH_SHORT).show();
                Intent intentt = new Intent(getApplication(), List_Remove_LPN.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("return_ea_unit_position", ea_unit_position);
