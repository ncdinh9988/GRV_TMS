...
public class ImageOrderAdapter extends RecyclerView.Adapter<ImageOrderAdapter.ViewHolder> {
   ...
   // private FCustomerAddNewEdit fCustomerAddNewEdit;
    ...
    public ImageOrderAdapter(Context context, ArrayList<Bitmap> arrImage, FrameLayout frameLayout, LinearLayout layout, ImageView imgDisplay, ImageView imgClose){
    ...
    public ImageOrderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ImageOrderAdapter.ViewHolder(view);
    }
