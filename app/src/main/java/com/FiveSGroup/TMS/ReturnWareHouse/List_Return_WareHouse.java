...
public class List_Return_WareHouse extends AppCompatActivity implements View.OnClickListener {
    ...
    private void prepareData(){
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                Toast.makeText(List_Return_WareHouse.this, "Đã xóa ", Toast.LENGTH_SHORT).show();
    ...
    private boolean isNotScanFromOrTo() {
        ...
        for (int i = 0; i < product.size(); i++) {
            ...
            String positionCode = return_wareHouse.getPOSITION_FROM_CODE();
            String valueCode = return_wareHouse.getLPN_CODE();
