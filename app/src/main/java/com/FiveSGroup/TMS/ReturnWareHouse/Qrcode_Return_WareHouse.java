...
public class Qrcode_Return_WareHouse extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                init();
                if (ContextCompat.checkSelfPermission(Qrcode_Return_WareHouse.this, Manifest.permission.CAMERA)
                        == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(Qrcode_Return_WareHouse.this, new String[]{Manifest.permission.CAMERA}, 123);
                } else {
                    startScanning();
                }
            }else {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    CmnFns.hideSoftKeyboard(Qrcode_Return_WareHouse.this);
                }catch (Exception e){
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_Return_WareHouse.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Qrcode_Return_WareHouse.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Qrcode_Return_WareHouse.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Qrcode_Return_WareHouse.this, barcodeData + "", Toast.LENGTH_LONG).show();
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
    ...
    private void getinformation(final String barcodeData) {
        int statusGetCustt = new CmnFns().getDataFromSeverWithBatch2(barcodeData, CmnFns.readDataAdmin(), "WRW", 0, global.getReturnCD());
//        if (statusGetCustt != 1) {
                                ...
                                if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                                    if (expDate != "") {
                                        ...
                                        if (chuoi[0].equals("Khác")){
                                            Intent intent = new Intent(Qrcode_Return_WareHouse.this, SelectPropertiesProductActivity.class);
                                            intent.putExtra("typeScan", "scan_from_return_warehouse");
...
//        }
    ...
    private void Checkproduct_Code(){
        Intent intentt = new Intent(getApplication(), List_Return_WareHouse.class);
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow,final String batch_number) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_Return_WareHouse.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_Return_WareHouse.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(Qrcode_Return_WareHouse.this, List_Return_WareHouse.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("pro_code", pro_code);
