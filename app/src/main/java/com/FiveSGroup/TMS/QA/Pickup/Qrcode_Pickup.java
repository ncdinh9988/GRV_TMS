...
import com.FiveSGroup.TMS.QA.HomeQA.Qrcode_QA;
...
public class Qrcode_Pickup extends AppCompatActivity implements View.OnClickListener {
...
private CodeScanner mCodeScanner;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting == 2131296696) {
                    ...
                    if (ContextCompat.checkSelfPermission(Qrcode_Pickup.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(Qrcode_Pickup.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(Qrcode_Pickup.this);
                } catch (Exception e) {
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_Pickup.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void getDataFromIntent() {
        ...
        if (!(position == null)) {
            ...
            checkBoxGetLPN.setChecked(false);
            textViewTitle.setText("QUÉT MÃ - LẤY HÀNG");
        }
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Qrcode_Pickup.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Qrcode_Pickup.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Qrcode_Pickup.this, barcodeData + "", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(Qrcode_Pickup.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
                                ...
                                if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                                    if (expDate != "") {
                                        ...
                                        if (chuoi[0].equals("Khác")) {
                                            Intent intent = new Intent(Qrcode_Pickup.this, SelectPropertiesProductActivity.class);
                                    ...
                                    Toast.makeText(Qrcode_Pickup.this, "You select: " + expDate,
...
// khi kh không check vào đơn vị tính mặc định isdefault mặc định là 1 còn khi check vào là 2
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow ,final String batch_number ) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_Pickup.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_Pickup.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), List_Pickup.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("batch_number", batch_number);
