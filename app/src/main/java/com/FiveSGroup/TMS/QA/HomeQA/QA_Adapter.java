...
//                            DatabaseHelper.getInstance().deleteProduct_QA_Specific(product.getPRODUCT_CODE(), product.getEXPIRED_DATE(), product.getSTOCKIN_DATE(), product.getUNIT(), product.getSTOCKOUT_CD());
...
//                    DatabaseHelper.getInstance().updateProduct_QA(product, product.getAUTOINCREMENT(),product.getPRODUCT_CD(), "0", product.getUNIT(), product.getSTOCKIN_DATE(), product.getCANCEL_CD());
                } else {
//                    DatabaseHelper.getInstance().updateProduct_QA(product, product.getAUTOINCREMENT(), product.getPRODUCT_CD(), s.toString(), product.getUNIT(), product.getSTOCKIN_DATE(), product.getSTOCK_TRANSFER_POSTING_CD());
                }
            }
        });
...
//                    } else {
//                        // the user is done typing.
//                        DatabaseHelper.getInstance().updateProduct_QA(product, product.getAUTOINCREMENT(), product.getPRODUCT_CD(), holder.edt.getText().toString(), product.getUNIT(), product.getSTOCKIN_DATE(), product.getSTOCK_TRANSFER_POSTING_CD());
...
////                            DatabaseHelper.getInstance().updateProduct_QA(product, product.getPRODUCT_CD(), holder.edt.getText().toString(), "0", product.getSTOCKIN_DATE(), product.getSTOCKOUT_CD());
