...
import com.FiveSGroup.TMS.QA.Pickup.Qrcode_Pickup;
...
public class Qrcode_Return_QA extends AppCompatActivity implements View.OnClickListener {
...
//            initialiseDetectorsAndSources();
            if (ContextCompat.checkSelfPermission(Qrcode_Return_QA.this, Manifest.permission.CAMERA)
                ...
                ActivityCompat.requestPermissions(Qrcode_Return_QA.this, new String[] {Manifest.permission.CAMERA}, 123);
            } else {
                startScanning();
            }
        }
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(Qrcode_Return_QA.this);
                } catch (Exception e) {
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_Return_QA.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//                try {
//                    if (ActivityCompat.checkSelfPermission(Qrcode_Return_QA.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
//                        cameraSource.start(surfaceView.getHolder());
//                    } else {
//                        ActivityCompat.requestPermissions(Qrcode_Return_QA.this, new
...
//                                    Toast.makeText(Qrcode_Return_QA.this, barcodeData + "", Toast.LENGTH_LONG).show();
...
//                                    }
//                                } catch (Exception e) {
//                                    Toast.makeText(Qrcode_Return_QA.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
...
//*****************************
        if (checkBoxGetLPN.isChecked()) {
            if (expiredDate != null) {
                Intent intentt = new Intent(getApplication(), List_Return_QA.class);
            ...
            if (statusGetcode != 1) {
                ...
                if (product_s_ps.size() > 1) {
                    final AlertDialog.Builder builder = new AlertDialog.Builder(Qrcode_Return_QA.this);
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
    ...
    private void getinformation(final String barcodeData) {
        int statusGetCustt = new CmnFns().getDataFromSeverWithBatch2(barcodeData, CmnFns.readDataAdmin(), "WQA_Return", 0, global.getReturnQACD());
//        if (statusGetCustt != 1) {
                                ...
                                if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                                    if (expDate != "") {
                                        ...
                                        if (chuoi[0].equals("Khác")) {
                                            Intent intent = new Intent(Qrcode_Return_QA.this, SelectPropertiesProductActivity.class);
                                    ...
                                    Toast.makeText(Qrcode_Return_QA.this, "You select: " + expDate,
...
// khi kh không check vào đơn vị tính mặc định isdefault mặc định là 1 còn khi check vào là 2
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow ,final String batch_number ) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_Return_QA.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_Return_QA.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), List_Return_QA.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("batch_number", batch_number);
