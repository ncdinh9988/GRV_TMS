...
public class Home_Stockout_Total extends AppCompatActivity {

    RecyclerView rvCategory;
    ArrayList<MenuItemObject> arrItem;
    Arr_Adapter_Stockout adpater;
...
//        }
        ...
        adpater = new Arr_Adapter_Stockout(this, arrItem);
    ...
    private void prepareData(){
        ...
        String name[] = {"Xuất Kho SO", "Xuất Kho OD"};
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home_Stockout_Total.this, MainWareHouseActivity.class);
