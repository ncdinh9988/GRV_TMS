...
public class Qrcode_Stock_Out extends AppCompatActivity implements View.OnClickListener {
...
//            initialiseDetectorsAndSources();
            if (ContextCompat.checkSelfPermission(Qrcode_Stock_Out.this, Manifest.permission.CAMERA)
                    == PackageManager.PERMISSION_DENIED){
                ActivityCompat.requestPermissions(Qrcode_Stock_Out.this, new String[] {Manifest.permission.CAMERA}, 123);
            } else {
                startScanning();
            }
        }
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_Stock_Out.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//                try {
//                    if (ActivityCompat.checkSelfPermission(Qrcode_Stock_Out.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
//                        cameraSource.start(surfaceView.getHolder());
//                    } else {
//                        ActivityCompat.requestPermissions(Qrcode_Stock_Out.this, new
...
//                                    Toast.makeText(Qrcode_Stock_Out.this, barcodeData + "", Toast.LENGTH_LONG).show();
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
                    ...
                    Toast.makeText(Qrcode_Stock_Out.this, "Mã Barcode Không Có Trong Hệ Thống", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(Qrcode_Stock_Out.this, ListQrcode_Stockout.class);
                    startActivity(intent);
                    finish();
                }
    ...
    private void getinformation(final String barcodeData) {
        int statusGetCustt = new CmnFns().getDataFromSeverWithBatch2(barcodeData, CmnFns.readDataAdmin(), "WSO", 0, global.getStockoutCD());
//        if (statusGetCustt != 1) {
...
//                            String chuoi[] = expDatetemp.split(" - ");
                        ...
                        Toast.makeText(Qrcode_Stock_Out.this, "Sản Phẩm Không Có Trong Phiếu", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Qrcode_Stock_Out.this, ListQrcode_Stockout.class);
...
//        }
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow , final String batch_number) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_Stock_Out.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_Stock_Out.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), ListQrcode_Stockout.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("batch_number", batch_number);
