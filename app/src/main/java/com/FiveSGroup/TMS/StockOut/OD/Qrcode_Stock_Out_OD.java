...
public class Qrcode_Stock_Out_OD extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting.equals("HoneyWell")) {
                    ...
                    if (ContextCompat.checkSelfPermission(Qrcode_Stock_Out_OD.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(Qrcode_Stock_Out_OD.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position != null || checkToFinish != null) {
                    Intent intent = new Intent(Qrcode_Stock_Out_OD.this, Home_Stockout_OD.class);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(Qrcode_Stock_Out_OD.this);
                } catch (Exception e) {
    ...
    private void ShowSuccessMessage(String message) {
        LayoutInflater factory = LayoutInflater.from(Qrcode_Stock_Out_OD.this);
        View layout_cus = factory.inflate(R.layout.layout_show_check_wifi, null);
        final AlertDialog dialog = new AlertDialog.Builder(Qrcode_Stock_Out_OD.this, R.style.Theme_AppCompat_Light_Dialog_MinWidth).create();
        ...
        if(message.equals("Lưu thành công")){
            btnClose.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialog.dismiss();
                    Intent intentToHomeQRActivity = new Intent(Qrcode_Stock_Out_OD.this, Home_Stockout_OD.class);
    ...
    private void GetData(final String barcodeData) {
        ...
        Intent intent = new Intent(Qrcode_Stock_Out_OD.this, Qrcode_Stock_Out_OD_Finish.class);
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Qrcode_Stock_Out_OD.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Qrcode_Stock_Out_OD.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Qrcode_Stock_Out_OD.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
                                }
