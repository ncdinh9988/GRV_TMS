...
public class LetDownQrCodeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting == 2131296696) {
                    ...
                    if (ContextCompat.checkSelfPermission(LetDownQrCodeActivity.this, Manifest.permission.CAMERA)
                        ...
                        ActivityCompat.requestPermissions(LetDownQrCodeActivity.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    CmnFns.hideSoftKeyboard(LetDownQrCodeActivity.this);
                }catch (Exception e){
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(LetDownQrCodeActivity.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(LetDownQrCodeActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(LetDownQrCodeActivity.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    Toast.makeText(LetDownQrCodeActivity.this, barcodeData + "", Toast.LENGTH_LONG).show();
                                ...
                                if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                                    if (expDate != "") {
                                        ...
                                        if (chuoi[0].equals("Khác")){
                                            Intent intent = new Intent(LetDownQrCodeActivity.this, SelectPropertiesProductActivity.class);
                                    ...
                                    Toast.makeText(LetDownQrCodeActivity.this, "You select: " + expDate,
...
//        }
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow,final String batch_number) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(LetDownQrCodeActivity.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(LetDownQrCodeActivity.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), LetDownActivity.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("batch_number", batch_number);
