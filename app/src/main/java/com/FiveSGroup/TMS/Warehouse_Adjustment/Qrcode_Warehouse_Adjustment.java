...
import com.FiveSGroup.TMS.TransferQR.ChuyenMa.List_ChuyenMa;
import com.FiveSGroup.TMS.TransferQR.ChuyenMa.Qrcode_ChuyenMa;
...
public class Qrcode_Warehouse_Adjustment extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                init();
                if (ContextCompat.checkSelfPermission(Qrcode_Warehouse_Adjustment.this, Manifest.permission.CAMERA)
                        == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(Qrcode_Warehouse_Adjustment.this, new String[]{Manifest.permission.CAMERA}, 123);
                } else {
                    startScanning();
                }
            }else {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    CmnFns.hideSoftKeyboard(Qrcode_Warehouse_Adjustment.this);
                }catch (Exception e){
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_Warehouse_Adjustment.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Qrcode_Warehouse_Adjustment.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Qrcode_Warehouse_Adjustment.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Qrcode_Warehouse_Adjustment.this, barcodeData + "", Toast.LENGTH_LONG).show();
                                ...
                                if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                                    if (expDate != "") {
                                        ...
                                        if (chuoi[0].equals("Khác")){
                                            Intent intent = new Intent(Qrcode_Warehouse_Adjustment.this, SelectPropertiesProductActivity.class);
                                            intent.putExtra("typeScan", "scan_from_warehouse_adjustment");
                                    ...
                                    Toast.makeText(Qrcode_Warehouse_Adjustment.this, "You select: " + expDate,
...
//        }
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow,final String batch_number) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_Warehouse_Adjustment.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_Warehouse_Adjustment.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), ListQrcode_Warehouse_Adjustment.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("return_ea_unit_position", ea_unit_position);
