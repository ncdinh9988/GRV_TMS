...
import com.FiveSGroup.TMS.PickList.PickListQrCode;
...
public class Qrcode_PoReturn extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting.equals("HoneyWell")) {
                    ...
                    if (ContextCompat.checkSelfPermission(Qrcode_PoReturn.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(Qrcode_PoReturn.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(Qrcode_PoReturn.this);
                } catch (Exception e) {
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_PoReturn.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Qrcode_PoReturn.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Qrcode_PoReturn.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Qrcode_PoReturn.this, barcodeData + "", Toast.LENGTH_LONG).show();
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
                        ...
                        Toast.makeText(Qrcode_PoReturn.this, "Mã Barcode Không Có Trong Hệ Thống", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Qrcode_PoReturn.this, ListQrcode_PoReturn.class);
                        startActivity(intent);
                        finish();
                    }
                        ...
                        builder.setItems(mString, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                                    ...
                                    Toast.makeText(Qrcode_PoReturn.this, "You select: " + expDate,
...
// khi kh không check vào đơn vị tính mặc định isdefault mặc định là 1 còn khi check vào là 2
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow ,final String batch_number ) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_PoReturn.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_PoReturn.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), ListQrcode_PoReturn.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("returnposition", position);
                intentt.putExtra("batch_number", batch_number);
