...
public class LPNOD extends AppCompatActivity {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting.equals("HoneyWell")) {
                    ...
                    if (ContextCompat.checkSelfPermission(LPNOD.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(LPNOD.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
...
//                }
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(LPNOD.this);
                } catch (Exception e) {
    ...
    private void ShowSuccessMessage(String message) {
        LayoutInflater factory = LayoutInflater.from(LPNOD.this);
        View layout_cus = factory.inflate(R.layout.layout_show_check_wifi, null);
        final AlertDialog dialog = new AlertDialog.Builder(LPNOD.this, R.style.Theme_AppCompat_Light_Dialog_MinWidth).create();
    ...
    private void GetData(final String barcodeData) {
        ...
        Intent intent = new Intent(LPNOD.this,LPNOD_Finish.class);
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(LPNOD.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(LPNOD.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(LPNOD.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
                                }
