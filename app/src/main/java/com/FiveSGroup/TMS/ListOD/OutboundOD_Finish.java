...
public class OutboundOD_Finish extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting.equals("HoneyWell")) {
                    ...
                    if (ContextCompat.checkSelfPermission(OutboundOD_Finish.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(OutboundOD_Finish.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position != null || checkToFinish != null) {
                    Intent intent = new Intent(OutboundOD_Finish.this, HomeOD.class);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(OutboundOD_Finish.this);
                } catch (Exception e) {
    ...
    private void ShowSuccessMessage(String message) {
        LayoutInflater factory = LayoutInflater.from(OutboundOD_Finish.this);
        View layout_cus = factory.inflate(R.layout.layout_show_check_wifi, null);
        final AlertDialog dialog = new AlertDialog.Builder(OutboundOD_Finish.this, R.style.Theme_AppCompat_Light_Dialog_MinWidth).create();
    ...
    private void GetData(final String barcodeData) {
        ...
        Intent intent = new Intent(OutboundOD_Finish.this,OutboundOD.class);
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(OutboundOD_Finish.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(OutboundOD_Finish.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(OutboundOD_Finish.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
                                }
