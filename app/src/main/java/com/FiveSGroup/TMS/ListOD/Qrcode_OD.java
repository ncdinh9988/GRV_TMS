...
public class Qrcode_OD extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) && (Build.VERSION.SDK_INT <= Build.VERSION_CODES.Q)) {
                ...
                if (setting.equals("HoneyWell")) {
                    ...
                    if (ContextCompat.checkSelfPermission(Qrcode_OD.this, Manifest.permission.CAMERA)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(Qrcode_OD.this, new String[]{Manifest.permission.CAMERA}, 123);
                    } else {
                        startScanning();
                    }
                }
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    CmnFns.hideSoftKeyboard(Qrcode_OD.this);
                } catch (Exception e) {
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Qrcode_OD.this, result.getText(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Qrcode_OD.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Qrcode_OD.this, new
                        ...
                        barcodeText.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Qrcode_OD.this, barcodeData + "", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(Qrcode_OD.this, "Vui Lòng Thử Lại", Toast.LENGTH_LONG).show();
    ...
    private void GetData(final String barcodeData) {
        ...
        if (checkBoxGetLPN.isChecked()) {
            if (expiredDate != null) {
                ...
                Intent intentt = new Intent(getApplication(), Qrcode_OD.class);
                intentt.putExtra("lpn", "444");
                intentt.putExtra("btn1", barcodeData);
                intentt.putExtra("inventory", "333");
                startActivity(intentt);
            ...
            if(!(position == null)){
                ...
                if (statusGetcode != 1) {
                    ...
                    if (product_s_ps.size() > 1) {
                        final AlertDialog.Builder builder = new AlertDialog.Builder(Qrcode_OD.this);
...
//                        String product_code = product_s_ps.get(vitri).getPRODUCT_CODE();
                        ...
                        Toast.makeText(Qrcode_OD.this, "Mã Barcode Không Có Trong Hệ Thống", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Qrcode_OD.this, ListPickPositionOD.class);
                        startActivity(intent);
                        finish();
                    }
                    ...
                    if ((pro_code.equals("")) || (pro_code.equals(product_code))) {
                        if (expDate != "") {
                            ...
                            if (chuoi[0].equals("Khác")){
                                Intent intent = new Intent(Qrcode_OD.this, SelectPropertiesProductActivity.class);
                        ...
                        Toast.makeText(Qrcode_OD.this, "You select: " + expDate,
...
//        }
    ...
    private void ShowDialogUnit(final String barcode, final String expDateTemp2, final String stockinDateShow,final String batch_number) {
        ...
        AlertDialog.Builder builderDVT = new AlertDialog.Builder(Qrcode_OD.this);
        ...
        builderDVT.setItems(mString, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Qrcode_OD.this, mString[which], Toast.LENGTH_LONG).show();
                Intent intentt = new Intent(getApplication(), ListPickPositionOD.class);
                intentt.putExtra("btn1", barcode);
                intentt.putExtra("pro_code", pro_code);
                intentt.putExtra("pro_name", pro_name);
