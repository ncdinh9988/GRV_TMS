...
//                            DatabaseHelper.getInstance().deleteProduct_ChuyenMa_Specific(product.getPRODUCT_CODE(), product.getEXPIRED_DATE(), product.getSTOCKIN_DATE(), product.getUNIT(), product.getSTOCKOUT_CD());
...
//                    } else {
//                        // the user is done typing.
//                        DatabaseHelper.getInstance().updateProduct_ChuyenMa(product, product.getAUTOINCREMENT(), product.getPRODUCT_CD(), holder.edt.getText().toString(), product.getUNIT(), product.getSTOCKIN_DATE(), product.getSTOCK_TRANSFER_POSTING_CD());
...
////                            DatabaseHelper.getInstance().updateProduct_ChuyenMa(product, product.getPRODUCT_CD(), holder.edt.getText().toString(), "0", product.getSTOCKIN_DATE(), product.getSTOCKOUT_CD());
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            edt.addTextChangedListener(new TextWatcher() {
                ...
                @Override
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    listChuyenMa.get(getAdapterPosition()).setQTY(edt.getText().toString());
                }
